...
@Component({
  selector: 'app-nav-content-etudiant',
  standalone: true,
  imports: [CommonModule, RouterModule, NavCollapseComponent, NavGroupComponent, NavItemComponent, SharedModule],
  templateUrl: './nav-content-etudant.component.html',
  styleUrl: './nav-content-etudant.component.scss'
})
export class NavContentEtudiantComponent implements OnInit {
