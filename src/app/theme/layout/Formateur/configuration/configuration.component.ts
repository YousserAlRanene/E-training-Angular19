...
@Component({
  selector: 'app-formateur-configuration',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './formateur-configuration.component.html',
  styleUrl: './formateur-configuration.component.scss'
})
export class FormateurConfigurationComponent implements OnInit {
  // public method
