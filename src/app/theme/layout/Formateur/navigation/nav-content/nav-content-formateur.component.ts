...
@Component({
  selector: 'app-nav-content-formateur',
  standalone: true,
  imports: [CommonModule, RouterModule, NavCollapseComponent, NavGroupComponent, NavItemComponent, SharedModule],
  templateUrl: './nav-content-formateur.component.html',
  styleUrl: './nav-content-formateur.component.scss'
})
export class NavContentFormateurComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.userData = this._loggingService.getLocalStorage()
